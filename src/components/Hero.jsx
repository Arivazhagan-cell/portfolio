...
import CV from '../assets/Arivazhagan_R_F.pdf'
import { DownloadIcon, Mail } from 'lucide-react'
import hi from '../assets/hi.png'
import hero from '../assets/hero.png'
function Hero({ darkMode }) {
  const socialIcons = [
    { icon: github, alt: 'Github',link:'https://github.com/Arivazhagan-cell' },
    { icon: instagram, alt: "Instagram",link:'#' },
    { icon: linkedin, alt: "Linkedin", link:'https://www.linkedin.com/in/arivazhaganr07/' }
  ];
  ...
  return (
    <div className='relative overflow-hidden min-h-screen flex flex-col'>
      ...
      >
        ...
        py-14 lg:py-32 flex-col lg:flex-row items-center justify-between lg:mt-14 mt-14
        '>
          <div className='lg:w-1/2 w-full flex flex-col items-center lg:items-start text-center lg:text-left mb-12 lg:mb-0'>
            <div className='flex justify-center lg:justify-start gap-4 sm:gap-6 sm:mb-7 w-full'>
              {socialIcons.map((social, index) => (
                <a
                  ...
                  className='transfrom hover:scale-110 transition-transform duration-300'
                >
                  <img
                    src={social.icon}
                    alt={social.alt}
            ...
            <p className={`mb-6 sm:mb-8 leading-relaxed max-w-md
              ...
              Skilled in the MERN stack and passionate about solving real-world problems.</p>
            {/* Buttons */}
            <div className='w-full pt-4 sm:pt-6'>
              <div className='flex flex-col sm:flex-row justify-center
                ...
                <a href={CV} download className='w-full sm:w-auto'>
                 ...
                 rounded-full text-base sm:text-lg font-semibold transition-all durarion-300 transform
                 '>
                    <DownloadIcon className='w-4 h-4 sm:h-5 sm:w-5 mr-2' />
                    Download CV </button>
                </a>
                <a href='#contact' className='w-full sm:w-auto'>
                  <button className={`w-43 sm:w-auto inline-flex items-center ${theme.buttonSecondary} justify-center text-black
                 bg-linear-to-r  border-0 py-3 px-6 sm:px-8 hover:shadow-[0_0_40px_rgb(255,165,0,0.7)]
                 rounded-full text-base sm:text-lg font-semibold transition-all durarion-300 transform
                 `}>
          ...
          >
            <div className='relative w-4/5 sm:w-3/4 lg:w-full'>
              ...
              <img
               ...
               sm:left-20  w-14 h-14 sm:w-20 sm:h-20 object-contain animate-bounce
               opacity-90 z-10'
              />
            </div>
          </div>
